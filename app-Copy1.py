    ...
    try:
        ...
        for parameter in parameters:
            try:
                ...
                return jsonify({'status': 'Error', 'message': f'An error occurred while fitting the model for {parameter}: {e}'})
        ...
        for parameter in parameters:
            try:
                ...
                return jsonify({'status': 'Error', 'message': f'Error in SARIMA for {parameter}: {e}'})
